...
describe('Cifrado Management Component', () => {
  let comp: CifradoComponent;
  let fixture: ComponentFixture<CifradoComponent>;
  let service: CifradoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'cifrado', component: CifradoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CifradoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cifrados?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
